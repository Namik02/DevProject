...
public class FileHandler {
	 ...
	 */
	public static ArrayList<LogicTutor.model.Category> loadCategory() {

		ArrayList<LogicTutor.model.Category> result = new ArrayList<LogicTutor.model.Category>();
		int score;
		...
		try {
			...
			for (File fileEntry : folder.listFiles()) {
				LogicTutor.model.Category category = new Category(fileEntry.getName());
				...
				while ((line = br.readLine()) != null) {
					...
					LogicTutor.model.Question question = new Question(questionPrompt, answer, score);
	 ...
	 * @param db
	 */
	public static void saveDB(LogicTutor.db.ObjectDB db) {
		// Save Object
	 ...
	 * @param db
	 */
	public static LogicTutor.db.ObjectDB loadDB() {
		LogicTutor.db.ObjectDB db = null;
		// Read Object
