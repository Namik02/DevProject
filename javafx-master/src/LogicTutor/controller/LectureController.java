...
public class LectureController implements Initializable{
	...
	/**
	 * Navigate to Lec page
	 * @param event
	 */
	@FXML
	private void showLec1(ActionEvent event){
	 ...
	 */
	@FXML
	private void showLec2(ActionEvent event){
		ScreenController.goSelectionMenu(getClass(), event);
	}
	 ...
	 */
	@FXML
	private void showLec3(ActionEvent event){
		ScreenController.goSelectionMenu(getClass(), event);
	}
	 ...
	 */
	@FXML
	private void showLec4(ActionEvent event){
		ScreenController.goSelectionMenu(getClass(), event);
	}
