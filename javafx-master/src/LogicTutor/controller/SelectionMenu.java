...
/**
 * Controller class for question view at LoginView.fxml.
 * Display are question and text field
 * @author Neville
 */
public class SelectionMenu implements Initializable {
	 ...
	 */
	@FXML
	private void goLecture(ActionEvent event) throws IOException {
		ScreenController.goLecture(getClass(), event);
	}
	 ...
	 */
	@FXML
	private void goQuiz(ActionEvent event) throws IOException {
		ScreenController.goQuiz(getClass(), event);
	}
